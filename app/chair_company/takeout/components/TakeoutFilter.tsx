        ...
        <div className="bg-white border border-gray-400 p-3 mb-2 flex flex-col md:flex-row flex-wrap gap-3 items-end print:hidden shadow-sm">
            ...
            <div className="flex flex-col w-full md:w-64">
                <label className="text-[10px] font-bold uppercase text-gray-600 mb-1">
                    {t.chair_takeout.filters.search}
                </label>
            ...
            <div className="flex flex-col w-28">
                <label className="text-[10px] font-bold uppercase text-gray-600 mb-1">{t.chair_takeout.filters.rows}</label>
                <select
                    value={limit}
            ...
            <div className="ml-auto">
                ...
                >
                    <RotateCcw size={14} /> {t.chair_takeout.filters.reset}
                </button>
            </div>
        </div>
    );
