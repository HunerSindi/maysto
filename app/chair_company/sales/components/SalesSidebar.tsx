    ...
    return (
        <div className="space-y-3 print:hidden">
            ...
            <div className="bg-white border border-gray-400 p-3 shadow-sm">
                ...
                >
                    <Plus size={14} /> {t.chair_sales.actions.new_sale}
                </button>
                <button
                    onClick={handlePrint}
                ...
                >
                    <Printer size={14} /> {t.chair_sales.actions.print}
                </button>
            </div>
            ...
            <div className="bg-white border border-gray-400 p-3 shadow-sm">
                <h3 className="text-[10px] font-bold uppercase text-gray-500 mb-2 border-b border-gray-300 pb-1">
                    {t.chair_sales.actions.income_summary}
                </h3>

                <div className="mb-3">
                    <div className="flex items-center gap-2 text-gray-600 mb-1">
                        <TrendingUp size={14} />
                        <span className="text-[10px] uppercase font-bold text-gray-600">{t.chair_sales.actions.total_revenue}</span>
                    </div>
                ...
                <div className="flex justify-between items-center text-xs border-t border-gray-200 pt-2">
                    <span className="text-gray-500 font-bold uppercase text-[10px]">{t.chair_sales.actions.page_total}</span>
