        ...
        <div className="hidden print:block absolute top-0 left-0 w-full bg-white z-[9999] p-0 m-0">
            <table className="w-full border-collapse font-sans text-black">
                <thead>
                    ...
                    <tr><th colSpan={4} className="text-center text-lg font-bold uppercase pb-2">Sales Report (Chair Co)</th></tr>
                    <tr className="border border-black bg-gray-100">
                        ...
                        <th className="text-left text-[10px] uppercase p-2 border-r border-black">Note / Description</th>
                ...
                <tfoot>
                    <tr className="border border-black font-bold bg-gray-50">
                        <td colSpan={3} className="text-right p-2 text-xs uppercase border-r border-black">Total Sales Revenue:</td>
