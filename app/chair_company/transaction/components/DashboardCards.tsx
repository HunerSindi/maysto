...
import { TransactionDashboardData } from '@/types/chair';
...
export default function DashboardCards({ data }: { data: TransactionDashboardData | null }) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4 print:hidden">
            <Card
                title={t.chair_transaction.dashboard.store_balance}
            ...
            />
            <Card
                title={t.chair_transaction.dashboard.pending_sales}
            ...
            />
            <Card
                title={t.chair_transaction.dashboard.pending_expenses}
            ...
            />
            <Card
                title={t.chair_transaction.dashboard.projected_profit}
