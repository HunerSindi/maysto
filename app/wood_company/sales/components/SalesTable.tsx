                ...
                <table className="w-full text-left border-collapse">
                    <thead className="bg-gray-100 border-b border-gray-400 sticky top-0 z-10 shadow-sm">
                        <tr>
                            ...
                            <th className="p-2 border-r border-gray-300 text-xs font-bold uppercase w-24">Date</th>
                            <th className="p-2 border-r border-gray-300 text-xs font-bold uppercase w-48">Customer</th>
                    ...
                    <tbody className="divide-y divide-gray-200 text-sm bg-white">
                        {safeData.length === 0 ? (
                            <tr><td colSpan={6} className="p-8 text-center text-gray-500 italic">No sales found.</td></tr>
                        ) : (
                            safeData.map((item) => (
