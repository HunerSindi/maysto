...
import { WoodSaleMeta } from '@/types/wood';
            ...
            <div className="bg-white border border-gray-400 p-3 shadow-sm">
                ...
                <div className="mb-3">
                    <div className="flex items-center gap-2 text-gray-600 mb-1">
                        <TrendingUp size={14} />
                        <span className="text-[10px] uppercase font-bold text-gray-600">Total Sales</span>
                    </div>
                ...
                <div className="flex justify-between items-center text-xs border-t border-gray-200 pt-2">
                    <span className="text-gray-500 font-bold uppercase text-[10px]">Page Revenue</span>
