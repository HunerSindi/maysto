    ...
    return (
        <div className="bg-white border border-gray-400 p-3 mb-2 flex flex-col md:flex-row gap-3 items-end print:hidden shadow-sm">
            <div className="flex flex-col w-full md:w-64">
                <label className="text-[10px] font-bold uppercase text-gray-600 mb-1">{t.wood_customers.filters.find_label}</label>
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder={t.wood_customers.filters.search_ph}
                        value={search}
            ...
            <div className="flex flex-col w-28">
                <label className="text-[10px] font-bold uppercase text-gray-600 mb-1">{t.wood_customers.filters.rows}</label>
            ...
            <div className="ml-auto">
                <button onClick={handleReset} className="h-9 bg-gray-100 text-gray-700 px-3 text-xs font-bold uppercase border border-gray-400 hover:bg-gray-200 flex items-center gap-2 rounded-sm"><RotateCcw size={14} /> {t.wood_customers.filters.reset}</button>
            </div>
        </div>
    );
}