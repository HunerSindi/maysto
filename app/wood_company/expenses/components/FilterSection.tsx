        ...
        <div className="bg-white border border-gray-400 p-3 mb-2 flex flex-col md:flex-row flex-wrap gap-3 items-end print:hidden shadow-sm">
            ...
            <div className="flex flex-col w-full md:w-64">
                ...
                <div className="relative">
                    ...
                    <input type="text" className="w-full h-9 border border-gray-400 pl-8 pr-2 text-sm focus:border-amber-600 focus:outline-none transition-colors rounded-sm" placeholder="Category, Note..." value={search} onChange={(e) => setSearch(e.target.value)} />
                </div>
            </div>
